...
class PatrimonioServiceImplTest {
	...
	void inserirPatrimonio() {
		var marca1 = new Marca(1L, "Samsung");
		...
		var numTomboParaSomar = patrimonioServiceImpl.findByNumeroTombo();

		var patri2 = new Patrimonio(null, "tecnologia", "Valor: US$ 135,4 bilhões e Receita: US$ 260,5 bilhões",
				Long.sum(numTomboParaSomar, BigInteger.ONE.longValue()), marca1);
